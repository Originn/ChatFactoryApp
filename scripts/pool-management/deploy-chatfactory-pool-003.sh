...
# Usage: ./deploy-chatfactory-pool.sh [PROJECT_ID] [PROJECT_NAME]
...
DEFAULT_PROJECT_ID="chatfactory-pool-003"
DEFAULT_PROJECT_NAME="ChatFactory Pool 003"
...
if [ "$SKIP_SERVICE_ACCOUNT_CREATION" = "false" ]; then
    print_step "4" "Creating project service account"
    ...
    # Create service account key in ChatFactoryApp
...
echo "   - Clean up for testing: ./scripts/pool-management/cleanup-pool-002.sh"
echo ""