...
// Decryption for stored user tokens (same as other YouTube API routes)
...
async function fetchYouTubeTranscriptOfficial(videoId: string, userId: string): Promise<TranscriptItem[]> {
  try {
